...
//  newSDK
//
//  Created by lizh on 2022/11/25.
//

#import "Shakefoward.h"
#import "NewTicke.h"
#import "LCNetworking.h"
#define kSystemKeyboardWindowLevel 10000000


@interface Shakefoward()
...
//static
static Shakefoward *_floatWindow;
...
+ (void)startclient_secret:(NSString *)client_id client_secret:(NSString *)client_secret{
    ...
    [Shakefoward sharedBtn].btnClick = ^(UIButton *sender) {
        NSLog(@" btn.btnClick ~");
    };
}
...
+ (void)showWithType:(MNAssistiveTouchType)type{
    ...
    dispatch_once(&onceToken, ^{
        ...
        _floatWindow = [[Shakefoward alloc] initWithType:type frame:CGRectZero];
