...
- (instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:CGRectMake(frame.origin.x, frame.origin.y, 40, 40)]) {
...
//        NSString *title = [NSString stringWithFormat:@"Ver:%@ %@\nBuild:%@",MNFloatBtnSystemVersion,self.environmentStr, self.buildStr];
        ...
        bgImageView.frame = CGRectMake((60 - 35)/2, (60 - 35)/2,35,35);
        bgImageView.image = [ImageManage imageWithName:@"mainButton"];
